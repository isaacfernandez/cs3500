...
/**
 * Implementation of MusicRepresentation.
 */
...
public class Score implements MusicRepresentation {
  ...
  public Score() {
    ...
    this.tempo = 0;
    this.repeats = new HashMap<Integer, Skip>();
  }
  ...
  /**
   * Returns the length of the representation of the piece in beats Really just returns the max of
   * beat and duration
   *
  ...
  /**
   * Removes the note at beat n. Assumed that only one instrument is playing at a specific beat at a
   * certain octave, ie, there are no two notes the same with different durations
   */
  @Override
  ...
  /**
   * Returns a list of the tones at beat n Can return a list of size 0
   *
